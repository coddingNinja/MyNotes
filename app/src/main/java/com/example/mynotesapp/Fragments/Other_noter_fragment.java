 ...
 * Use the {@link Other_noter_fragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Other_noter_fragment extends Fragment implements RecyclerViewInterFaceForEachRow {
     ...
     * @return A new instance of fragment Other_noter_fragment.
     */
    // TODO: Rename and change types and number of parameters
    public static Other_noter_fragment newInstance(String param1, String param2) {
        Other_noter_fragment fragment = new Other_noter_fragment();
            ...
            public void onSuccess(ArrayList<EachNotes> notes) {
                if (isAdded()) {
                    if (notes.isEmpty()) {
                        ...
                        MyAdapterClassForEachRow adapter = new MyAdapterClassForEachRow(requireContext(), notes,Other_noter_fragment.this);
