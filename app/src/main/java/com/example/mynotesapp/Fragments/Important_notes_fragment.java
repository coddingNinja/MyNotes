 ...
 * Use the {@link Important_notes_fragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Important_notes_fragment extends Fragment implements RecyclerViewInterFaceForEachRow {
    ...
    public Important_notes_fragment() {
     ...
     * @return A new instance of fragment Important_notes_fragment.
     */
    // TODO: Rename and change types and number of parameters
    public static Important_notes_fragment newInstance(String param1, String param2) {
        Important_notes_fragment fragment = new Important_notes_fragment();
            ...
            public void onSuccess(ArrayList<EachNotes> notes) {
                if (isAdded()) {
                    if (notes.isEmpty()) {
                        ...
                        MyAdapterClassForEachRow adapter = new MyAdapterClassForEachRow(requireContext(), notes,Important_notes_fragment.this);
    ...
    public void onNotesClick(EachNotes eachNotes) {
        ...
        intent.putExtra("category","Important");
